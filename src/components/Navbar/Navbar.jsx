...
const Navbar = () => {
  ...
  const loginButton = (
    <>
      <Link to="login">
        <button
          className="middle none center rounded-lg bg-slate-800 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
          type="button"
    ...
    <div className="navbar bg-none lg:max-w-7xl mx-auto">
      ...
      <div className="nav navbar-start">
        ...
        <div className="flex flex-col justify-center items-center">
              ...
              >
                <span className=" text-xl font-medium uppercase">Scizers Technologies</span>
              </a>
        </div>
      </div>
      {/* Center */}
