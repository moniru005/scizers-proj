const Contact = () => {
  return (
    <>
      <section className="body-font relative  text-gray-800">
        <div className="container mx-auto px-5 pt-32 pb-12">
          <div className="mb-12 flex w-full flex-col text-center">
            <h1 className="title-font mb-4 text-2xl font-medium text-gray-800 sm:text-3xl uppercase">
              Contact Us
            </h1>
            ...
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="w-1/2 p-2">
                <div className="relative">
                  ...
                  <label
                    htmlFor="name"
                    className="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-black transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-black peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-black"
                  >
                    Name
                  </label>
                </div>
              ...
              <div className="w-full p-2">
                <button className="mx-auto flex rounded border-0 bg-slate-500 py-2 px-8 text-lg text-white hover:bg-slate-600 focus:outline-none">
                  Submit
                </button>
              </div>
            </div>
